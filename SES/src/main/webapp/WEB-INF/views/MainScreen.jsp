	...
	<main class="container-fluid">
		...
		<nav class="nav navbar-default">
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-center">
					<li><a class="nav-item" href="serviceInfo">서비스/회사 소개<span class="sr-only"></span></a></li>
		...
		<div class="row">
			<div class="col-md-2">
				<div class="row">
					<div class="col-md-2">
						<p><a href="login" style="font:30px bold; width:200px; height:150px;"><img src="${pageContext.request.contextPath}/resources/images/login.png" width="200px"></a></p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4">
