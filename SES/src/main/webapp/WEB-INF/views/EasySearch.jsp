	...
	<main class="container-fluid">
		...
		<div class="nav navbar-default">
			<ul class="nav navbar-nav navbar-right">
				<li><a class="nav-item"><h5>tytyjacob님 환영합니다!</h5></a><span class="sr-only"></span></li>
				<li><a class="nav-item" href="logout"><h5>로그아웃</h5><span class="sr-only"></span></a></li>
				<li><a class="nav-item" href="modify"><h5>회원정보수정</h5><span class="sr-only"></span></a></li>
			</ul>
		</div>
			...
			<div class="panel-body">
				...
				<div class="top-menu container">
					<ul class="nav nav-tabs">
						<li style="background-color: #4267b2;">
							<p class="tab" data-toggle="tab" style="border-top-left-radius: 2em; border-top-right-radius: 2em;">
								<table style="background-color: #4267b2;">
									<tr>
										...
										<td>
											<a href="easySearch?kind=facebook" style="color: White; text-decoration: none;">페이스북</a>
										</td>
										<td width="10px"></td>
									</tr>
								</table>
							...
							<p class="tab" data-toggle="tab" style="border-top-left-radius: 2em; border-top-right-radius: 2em;">
								<table style="background-color: #f9e000">
									<tr>
										...
										<td>
											<a href="easySearch?kind=kakaotalk" style="color: #3b1c1c; text-decoration: none;">카카오톡</a>
										</td>
										<td width="10px"></td>
									</tr>
								</table>
							...
							<p class="tab" data-toggle="tab" style="border-top-left-radius: 2em; border-top-right-radius: 2em;">
								<table style="background-color: #1dc800">
									<tr>
										...
										<td>
											<a href="easySearch?kind=naver" style="color: White; text-decoration: none;">네이버</a>
										</td>
										<td width="10px"></td>
									</tr>
								</table>
				...
				<br/><br/>
					<table class="table table-hover" style="width: 90%; color: White">
						...
						src="${pageContext.request.contextPath}/resources/images/cancel.png" width="50px"></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
					...
					<form action="search" name="searchForm">
						...
						<div class="row">
							...
							<div class="col-md-4 align-self-center" align="left">
								<p><input type="image" name="button" width="50px" src="${pageContext.request.contextPath}/resources/images/search.png"></p>
							</div>
						</div>
					</form>
					<br /> <br /> <br />
